...
namespace BlazingTrails.Shared
{
    public class GetTrailsRequest
    {
        ...
        public record Trail(int Id, string Name, string Image, string Location, int TimeInMinutes, int Length, string Description, IEnumerable<RouteInstruction> RouteInstructions);
